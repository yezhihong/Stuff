"$Id: vimspell.vim,v 1.100 2005/09/14 11:51:40 clabaut Exp $
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Name:		    vimspell
...
"
let s:spell_francais_iskeyword  =  "@,48-57,_,192-255,39,?,?,?,?,-"
...
let s:spell_francais_tex_iskeyword  =  "@,48-57,_,192-255,39,?,?,?,?,-,:,\\"
...
function! s:SpellAddTriggerMapping(key)
  ...
  " not more available with vimspell ?ctivated in insert mode.
...
"
  let s:revision=
	\ substitute("$Revision: 1.100 $",'\$\S*: \([.0-9]\+\) \$','\1','')

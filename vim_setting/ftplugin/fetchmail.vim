if exists("b:user_did_fetchmailftplugin")
    finish
endif
let b:user_did_fetchmailftplugin = 1

setlocal fo=tq

if !exists("b:no_user_fetchmailftplugin_maps")
    noremap <buffer> ,c :silent! call <SID>MakeFolder()<CR>
    vnoremap <buffer> ,ci :CreateFolder Include<CR> 
    noremap <buffer> ,/ I#<ESC>^
    noremap <buffer> ,\ ^x
endif
let b:no_user_fetchmailftplugin_maps=1
